      ...
      <div className="flex flex-row justify-evenly">
        <div className="flex flex-wrap gap-10 justify-center">
          {languages.map((skill, id) => (
            <div key={id} className="flex flex-col items-center gap-3 rounded-lg w-48 p-4 border border-white hover:bg-slate-500 transition-all duration-300 ease-in-out hover:bg-opacity-25">
              ...
              <p className="text-2xl sm:text-xl font-medium">{skill.title}</p>
            </div>
          ))}
        </div>
      </div>
